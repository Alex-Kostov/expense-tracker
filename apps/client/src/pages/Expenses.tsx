...
const Expenses = () => {
	...
	const expensesVaultsMap = mapTransactionsWithVaultNames(expenses, vaults);
	const expensesCategoriesMap = mapTransactionsWithCategoryNames(expensesVaultsMap, categories);
